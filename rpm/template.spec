...
Name:           ros-rolling-apex-test-tools
Version:        0.0.2
Release:        7%{?dist}%{?release_suffix}
Summary:        ROS apex_test_tools package

License:        Apache License 2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-rolling-ament-cmake-gtest
Requires:       ros-rolling-osrf-testing-tools-cpp
...
%if 0%{?with_tests}
BuildRequires:  ros-rolling-ament-cmake-pclint
...
%changelog
* Tue Jun 20 2023 Apex.AI, Inc. <opensource@apex.ai> - 0.0.2-7
